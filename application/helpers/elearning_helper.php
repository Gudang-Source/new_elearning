...
function default_parser_item($add_item = array())
{
    ...
    $return = array(
        ...
        'copyright_setup'   => '' . date('Y') . ' e-learning.corp - <a href="http://www.almadani.online">almadani.online</a>',
    ...
    if ($CI->uri->segment(1) != 'setup') {
        $return['copyright'] = ' ' . date('Y') . ' ' . get_pengaturan('nama-sekolah', 'value').' by e-learning ';
